...
def draw_lines():
    ...
    while time.time() < t_end:
        ...
        x_slope = random.randrange(1, 7)
        y_slope = random.randrange(1, 7)
        ...
        if x_start < x_end and y_start < y_end:
            while x_start <= x_end and y_start <= y_end:
                pg.draw.line(screen, color, [x_start, y_start], [x_start + x_slope, y_start + y_slope], 3)
        ...
        # > and <
             ...
             while x_start >= x_end and y_start <= y_end:
                pg.draw.line(screen, color, [x_start, y_start], [x_start - x_slope, y_start + x_slope], 3)
                x_start = x_start - x_slope
                y_start = y_start + y_slope
                pg.display.flip()
        ...
        # = and <
             ...
             while x_start == x_end and y_start < y_end:
                pg.draw.line(screen, color, [x_start, y_start], [x_start, y_start + y_slope], 3)
                y_start = y_start + y_slope
                pg.display.flip()
        ...
        # < and =
             ...
             while x_start > x_end and y_start == y_end:
                pg.draw.line(screen, color, [x_start, y_start], [x_start + x_slope, y_start], 3)
                x_start = x_start + x_slope
                pg.display.flip()
